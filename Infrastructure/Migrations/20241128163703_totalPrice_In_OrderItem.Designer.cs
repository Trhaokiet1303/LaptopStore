...
namespace LaptopStore.Client.Migrations
{
    ...
    [Migration("20241128163703_totalPrice_In_OrderItem")]
    partial class totalPrice_In_OrderItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaptopStore.Domain.Entities.Catalog.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LaptopStore.Domain.Entities.Catalog.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LaptopStore.Domain.Entities.Catalog.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LaptopStore.Domain.Entities.Catalog.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LaptopStore.Infrastructure.Models.Audit.Audit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LaptopStore.Domain.Entities.Catalog.OrderItem", b =>
                {
                    b.HasOne("LaptopStore.Domain.Entities.Catalog.Order", "Order")
                        .WithMany("OrderItem")
            ...
            modelBuilder.Entity("LaptopStore.Domain.Entities.Catalog.Product", b =>
                {
                    b.HasOne("LaptopStore.Domain.Entities.Catalog.Brand", "Brand")
                        .WithMany()
