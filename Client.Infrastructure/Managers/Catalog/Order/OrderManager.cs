...
namespace LaptopStore.Client.Infrastructure.Managers.Catalog.Order
{
    public class OrderManager : IOrderManager
    {
        ...
        public async Task<IResult<GetOrderByIdResponse>> GetOrderByIdForUserAsync(int orderId)
        {
            var response = await _httpClient.GetAsync(Routes.OrdersEndpoints.GetOrderByIdForUser(orderId));
            return await response.ToResult<GetOrderByIdResponse>();
        }
